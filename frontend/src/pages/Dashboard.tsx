  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-[#0f172a] via-[#110e38] to-[#0f172a]">
      ...
      <div className="relative z-10 ">
        {/* Tab Navigation */}
        <div className="sticky top-14 z-40 bg-[#0f172a]/90 backdrop-blur-xl border-b border-white/[0.06]">
            ...
            <div className="flex gap-0.5 relative">
              ...
              >
                <div className="flex items-center gap-2">
                  <svg className={`w-4 h-4 transition-colors duration-300 ${tab === "build" ? "text-purple-400" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
                  </svg>
                  Build
                </div>
                {tab === "build" && (
                  <div className="absolute inset-0 bg-white/[0.04] rounded-t-lg" />
                )}
              </button>
              ...
              >
                <div className="flex items-center gap-2">
                  <svg className={`w-4 h-4 transition-colors duration-300 ${tab === "train" ? "text-purple-400" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                <div className="flex items-center gap-2">
                  <svg className={`w-4 h-4 transition-colors duration-300 ${tab === "test" ? "text-purple-400" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div
                className="absolute bottom-0 h-[2px] bg-purple-500 transition-all duration-300 ease-in-out"
                style={{
                  ...underlineStyle,
                  boxShadow: '0 0 8px rgba(168, 85, 247, 0.5), 0 0 20px rgba(168, 85, 247, 0.15)',
                }}
              ></div>
            </div>
          </div>
